...
/**
 * Hero — a full-viewport intro stage.
 *
 * The cutout portrait floats at the top-right on desktop. Entrance
 * animations only — no scroll-scrubbing and no background media.
 */
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-svh overflow-hidden bg-navy">
      ...
      <div className="pointer-events-none absolute right-[4%] top-[13%] z-20 hidden w-[min(34vh,26vw)] lg:block">
        <motion.div
      ...
      {/* content */}
      <div className="container-x relative z-10 flex h-full min-h-svh flex-col justify-center pb-24 pt-28">
        {/* kicker */}
